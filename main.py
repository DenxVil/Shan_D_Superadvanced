...
def main():
    ...
    # (Optional) Initialize Telegram bot interface
    bot = TelegramBot(
        token=cfg.telegram.token,
        get_response=enhanced.get_response  # delegates to ShanDEnhanced
    )
